"""
Django settings for my_app_45503 project.
...
ROOT_URLCONF = 'my_app_45503.urls'
...
WSGI_APPLICATION = 'my_app_45503.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "my_app_45503 API",
    "DESCRIPTION": "API documentation for my_app_45503 App",
    "VERSION": "v1",
}
